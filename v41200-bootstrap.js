...
(()=>{
  ...
  window.KEYSUITE_VERSION='4.25.04';
  window.KEYSUITE_BUILD='V4.25.04';
  const VERSION='42504';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.25.04';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.25.04':'V4.25.04'});document.documentElement.setAttribute('data-keysuite-version','4.25.04')}catch(_){} }
  (async()=>{
    ...
    try{window.dispatchEvent(new CustomEvent('KEYSUITE_V41300_RUNTIME_READY',{detail:{version:'4.25.04'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_RUNTIME_READY',{detail:{version:'4.25.04'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_BRAND_RECOVERY'))}catch(_){ }
  })();
})();
