...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.25.14';
  const VERSION='42514';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.25.14';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.25.14':'V4.25.14'});document.documentElement.setAttribute('data-keysuite-version','4.25.14')}catch(_){} }
  (async()=>{
